...
public class CloudEventImplTest {
    ...
    public void testEqualityV03() {
        CloudEvent event1 = BaseCloudEventBuilder.buildV03()
            .withId(ID)
            .withType(TYPE)
            .withSource(SOURCE)
        ...
        CloudEvent event2 = BaseCloudEventBuilder.buildV03()
            .withId(ID)
            .withType(TYPE)
            .withSource(SOURCE)
            .withData(DATACONTENTTYPE_JSON, DATASCHEMA, DATA_JSON_SERIALIZED)
    ...
    public void testEqualityV1() {
        CloudEvent event1 = BaseCloudEventBuilder.buildV1()
            .withId(ID)
            .withType(TYPE)
            .withSource(SOURCE)
            .withData(DATACONTENTTYPE_JSON, DATASCHEMA, DATA_JSON_SERIALIZED)
        ...
        CloudEvent event2 = BaseCloudEventBuilder.buildV1()
            .withId(ID)
            .withType(TYPE)
            .withSource(SOURCE)
            .withData(DATACONTENTTYPE_JSON, DATASCHEMA, DATA_JSON_SERIALIZED)
